...
import { Card, CardHeader, CardBody } from '../../../daily_co/components/Card';
import Loader from '../../../daily_co/components/Loader';
...
export const CreatingRoom = ({ onCreated }) => {
  ...
  useEffect(() => {
    ...
    async function createRoom() {
      ...
      let game_id = context?.game_config?._id;
      // let players = context?.game_config?.players;

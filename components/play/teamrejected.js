...
import bigReject from '../../public/images/big_reject.png';

const TeamRejected = (props) => {
    //----- others ------
    ...
    return (
        <div className={classes.wrapper}>
            <div className={classes.title}>Team Rejected!</div>          
            <div style={{width: '100%', display: 'flex', justifyContent: 'center', padding: '2.5vw'}}> 
                <img src={bigReject.src} alt='arrow' style={{width: '4.2vw', height: 'auto'}} />
            </div>
            ...
            <div style={{width: '100%', display: 'flex', justifyContent: 'center', marginTop: 6}}> 
                <div className={classes.number} style={{background: '#E22F2F', borderWidth: 0}}> 1 </div>
                <div className={classes.number} > 2 </div>
                <div className={classes.number} > 3 </div>
                <div className={classes.number} > 4 </div>
                <div className={classes.number} style={{marginRight: 0}}> 5 </div>
            </div>
